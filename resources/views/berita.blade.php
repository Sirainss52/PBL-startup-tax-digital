...
<section>
  <div class="container d-flex align-item-center justify-content-end ">
    <div class="mb-3">
      <select class="form-select form-select-lg bg-secondary text-white " name="" id="">
        <option cl selected class="u-text u-text-default u-text-1">Pilih Tag</option>
        <option value="" class="u-text u-text-default u-text-1">Lorem</option>
        <option value="" class="u-text u-text-default u-text-1">Ipsum</option>
        <option value="" class="u-text u-text-default u-text-1">Johnsur</option>
      </select>
    </div>
  </div>
</section>
            ...
            <div class="u-layout-row">
              ...
              <div class="u-align-left u-container-align-left u-container-style u-grey-5 u-layout-cell u-right-cell u-size-30 u-size-xs-60 u-layout-cell-2">
                <div class="u-container-layout u-valign-middle u-container-layout-2">
                  ...
                  <a href="{{ url ('/Detail-berita')}}" class="u-align-left u-btn u-button-style u-palette-1-base u-btn-1 btn btn-rounded">read more</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="u-layout">
            <div class="u-layout-row">
              ...
              <div class="u-align-left u-container-align-left u-container-style u-grey-5 u-layout-cell u-right-cell u-size-30 u-size-xs-60 u-layout-cell-2">
                <div class="u-container-layout u-valign-middle u-container-layout-2">
                  <h2 class="u-align-left u-text u-text-default u-text-1">Hot news </h2>
                  <p class="u-align-left u-text u-text-2">Samxzple text. Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.</p>
                  <a href="#" class="u-align-left u-btn u-button-style u-palette-1-base u-btn-1 btn btn-rounded">read more</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="u-layout-row">
          ...
          <div class="u-container-style u-layout-cell u-size-18 u-layout-cell-3">
            <div class="u-container-layout u-container-layout-3">
              <img class="u-align-center-sm u-align-center-xs u-image u-image-contain u-image-round u-radius u-image-1" src="/images/logo.png" alt="" data-image-width="616" data-image-height="405" />
