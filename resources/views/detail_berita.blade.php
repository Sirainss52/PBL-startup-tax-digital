    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-container-style u-expanded-width u-post-details u-post-details-1">
            <div class="u-container-layout u-valign-middle-lg u-valign-middle-xl u-container-layout-1">
                <!--blog_post_image-->
                <a class="u-post-header-link" href="/blog/post-6.html"><img alt="" class="u-align-center-sm u-align-center-xs u-blog-control u-expanded-width-lg u-expanded-width-xl u-image u-image-default u-image-1" src="/images/0fd3416c.jpeg" /></a><!--/blog_post_image--><!--blog_post_header-->
                <h2 class="u-blog-control u-text u-text-default-sm u-text-default-xs u-text-1">
        ...
        <!--/blog_post--><!--/post_details--><!--categories-->

        <!--/categories-->
        <div class='flex-container'>
            <p class="u-align-left u-text u-text-default-sm u-text-default-xs u-text-3">
                Tag :
            </p>
            <div class="u-categories u-categories-horizontal u-categories-1" data-products-datasource="site">
                <ul>
                    <li class="u-categories-item u-root u-expand-leaf">
                        <div class="u-categories-item-content u-categories-item-content-1">
                            <a class="u-button-style u-category-link u-nav-link" href="#" data-category=""><span class="u-icon">
                                    <svg class="icon" viewBox="0 0 16 16" fill-opacity="1">
                                        <use xlink:href="#icon-categories-leaf"></use>
                                    </svg>
                                </span>All</a>
                        </div>
                    </li>
                    <li class="u-categories-item u-root u-expand-leaf">
                        <div class="u-categories-item-content u-categories-item-content-1">
                            <a class="u-button-style u-category-link u-nav-link" href="#" data-category="1"><span class="u-icon">
                                    <svg class="icon" viewBox="0 0 16 16" fill-opacity="1">
                                        <use xlink:href="#icon-categories-leaf"></use>
                                    </svg>
                                </span>Clothes</a>
                    ...
                    <li class="u-categories-item u-root u-expand-leaf">
                        <div class="u-categories-item-content u-categories-item-content-1">
                            <a class="u-button-style u-category-link u-nav-link" href="#" data-category="2"><span class="u-icon">
                                    <svg class="icon" viewBox="0 0 16 16" fill-opacity="1">
                                        <use xlink:href="#icon-categories-leaf"></use>
                                    </svg>
                                </span>Shoes</a>
                    ...
                    <li class="u-categories-item u-root u-expand-leaf">
                        <div class="u-categories-item-content u-categories-item-content-1">
                            <a class="u-button-style u-category-link u-nav-link" href="#" data-category="3"><span class="u-icon">
                                    <svg class="icon" viewBox="0 0 16 16" fill-opacity="1">
                                        <use xlink:href="#icon-categories-leaf"></use>
                                    </svg>
                                </span>Accessories</a>
                ...
                <svg style="display: none">
                    <symbol id="icon-categories-open" viewBox="0 0 16 16">
                        <polygon points="12,10 9,6 15,6 "></polygon>
                    </symbol>
                    <symbol id="icon-categories-closed" viewBox="0 0 16 16">
                        <polygon points="14,8 10,11 10,5 "></polygon>
                    </symbol>
                    <symbol id="icon-categories-leaf" viewBox="0 0 16 16">
                        <polygon points="14,8 10,11 10,5 "></polygon>
                    </symbol>
                </svg>
                <svg style="display: none">
...
<section class="u-align-center u-clearfix u-section-2" id="sec-b0ab">
    <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <div class="u-repeater u-repeater-1">
                ...
                <div class="u-align-left u-container-align-left u-container-style u-list-item u-repeater-item">
                    <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2">
                        ...
                        <h4 class="u-align-left u-text u-text-4">
                            Sample Headline
                        </h4>
                ...
                <div class="u-align-left u-container-style u-list-item u-repeater-item">
                    <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3">
                        ...
                        <h4 class="u-align-left u-text u-text-6">
                            Sample Headline
                        </h4>
                ...
                <div class="u-align-left u-container-style u-list-item u-repeater-item">
                    <div class="u-container-layout u-similar-container u-valign-top u-container-layout-4">
                        ...
                        <h4 class="u-align-left u-text u-text-8">
                            Sample Headline
                        </h4>
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
                    ...
                    <div class="u-container-style u-layout-cell u-size-24 u-layout-cell-2">
                        <div class="u-border-2 u-border-no-bottom u-border-no-top u-border-white u-container-layout u-container-layout-2">
                            ...
                            <p class="u-align-left u-small-text u-text u-text-variant u-text-4">
                                Alamat : ​Jl. Ahmad Yani Batam Kota.<br />Kota
                                Batam, Kepulauan Riau, Indonesia.290461.
                            </p>
                        </div>
                    </div>
      ...
      H48.7c0,0,0.2-36.5,0-40.3h13.4v5.7c1.8-2.7,5-6.7,12.1-6.7c8.8,0,15.4,5.8,15.4,18.1V83.7z"></path>
        ...
        <p class="u-align-center u-text u-text-default u-text-5">
            © COPYRIGHT 2024 Startup tax digital. All rights reserved.
            Not for further distribution without the permission
            of&nbsp;Startup tax digital
        </p>
