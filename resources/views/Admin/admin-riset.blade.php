  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Riset</h5>
            <a href="{{ url('/admin-riset.create')}}" class="btn btn-primary"><i data-feather="plus"></i> Tambah riset </a>
            <div class="card">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>1-1-2024</td>
                      <td>
                        <a href="{{ url('/admin-riset.edit')}}" class="btn btn-warning">Edit riset <i data-feather="edit"></i></a>
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h1 class="modal-title fs-5" id="hapusModallabel">Hapus riset </h1>
