      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            ...
            <a href="{{ url('/admin-kegiatan.create')}}" class="btn btn-primary"><i data-feather="plus"></i> Tambah kegiatan </a>
            <div class="card">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>1-1-2024</td>
                      <td>
                        <a href="{{ url('/admin-kegiatan.edit')}}" class="btn btn-warning">Edit <i data-feather="edit"></i></a>
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h1 class="modal-title fs-5" id="hapusModallabel">Hapus kegiatan </h1>
