...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('js/tag.js')}}" />
  <link rel="stylesheet" href="{{ asset('js/universal.js')}}" />
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Tag</h5>
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"> <i data-feather="plus"></i> Tambah tag</button>
              <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">Menambah tag baru</h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form>
                        <div class="mb-3">
                          <label for="name-tag" class="col-form-label">nama tag:</label>
                          <input type="text" class="form-control" id="nama tag">
                        </div>
                      </form>
                    </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>tax</td>
                        <td>
                          <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal" data-bs-whatever="@Edit"><i data-feather="edit"></i> Edit</button>
                          ...
                          <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal" data-bs-whatever="@hapus"><i data-feather="trash"></i> Hapus</button>
