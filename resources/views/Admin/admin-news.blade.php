        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-primary"><i data-feather="plus"></i> tambah berita</a>
              <a class="btn btn-warning"><i data-feather="edit"></i> edit berita</a>
              <a class="btn btn-danger"><i data-feather="trash"></i> hapus berita</a>
              <div class="card">
