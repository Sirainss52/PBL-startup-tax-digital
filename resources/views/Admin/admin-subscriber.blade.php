    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Subscriber</h5>
              <a href="{{ url('/admin-subscriber.create')}}" class="btn btn-primary"><i data-feather="plus"></i> tambah pelanggan</a>
              <a href="{{ url('/admin-subscriber.edit')}}" class="btn btn-warning">Edit subscriber <i  data-feather="edit"></i></a>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="hapusModallabel">Hapus pelanggan </h1>
