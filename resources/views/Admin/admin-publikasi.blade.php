  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Publikasi</h5>
            <a href="{{ url('/admin-publikasi.create')}}" class="btn btn-primary"><i data-feather="plus"></i> Tambah publilkasi </a>
            <div class="card">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Mark</td>
                      <td>Otto lorem</td>
                      <td>apakah-itu-lorem-ipsum.png</td>
                      <td>1-1-2024</td>
                      <td>
                      <td>
                        <a href="{{ url('/admin-publikasi.edit')}}" class="btn btn-warning">Edit <i style="color: white;" data-feather="edit"></i></a>
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h1 class="modal-title fs-5" id="hapusModallabel">Hapus publikasi</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
                                <form>
                                  <div class="mb-3">
                                    <p> apakah anda yakin ingin menghapus publikasi ini ? </p>
                                  </div>
                                </form>
                              </div>
