  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h2 class="card-title fw-semibold mb-4">Company profile</h2>
            <div class="card">
              <div class="card-body">
                <form>
                  <div class="mb-3">
                    <label for="title" class="form-label">judul</label>
                    <input type="text" class="form-control" id="title" aria-describedby="emailName" disabled>
                  </div>
                  <div class="mb-3">
                    <label for="logo" class="form-label">Profile logo</label>
                    <input type="file" class="form-control" id="logo" disabled>
                    <img src="images/logos/logo-rounded.png" class="img-fluid img-thumbnail mt-3" style="max-width: 150px;">
                  </div>
                  <div class="mb-3">
